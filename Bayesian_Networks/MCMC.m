function results=MCMC(featuresForTraining,featuresForTest,classesForTraining,n,ns)
% This function obtains a graph struct for a bayesian network using MCMC
% algorithm.
...
% results - vector with the predicted classes for featuresForTest
    ...
    [sampled_graphs, accept_ratio] = learn_struct_mcmc([featuresForTraining,classesForTraining]', ns, 'nsamples', 1000);
    
    matrix=sampled_graphs{1,1000};
    
    draw_graph(matrix);
    
    bnet=mk_bnet(matrix,ns);
