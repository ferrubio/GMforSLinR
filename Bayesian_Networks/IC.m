function results=IC(featuresForTraining,featuresForTest,classesForTraining,n,ns)
% This function obtains a graph struct for a bayesian network using IC.
...
% results - vector with the predicted classes for featuresForTest 
    ...
    PDAG = learn_struct_pdag_ic_star('cond_indep_chisquare', n+1, n-1, [featuresForTraining,classesForTraining]');
    Graf = cpdag_to_dag(PDAG);
