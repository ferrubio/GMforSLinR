...
2.- DOWNLOAD THE PART A - PATH 1 OF FREIBURG, LJUBLJANA AND SAARBRUCKEN SEQUENCES FROM COLD DATASET (http://www.cas.kth.se/COLD/downloads.php), INTO
    $MATLAB_CODE/dataset/COLD/ WITH THE NEXT STRUCTURE
...
7.- LEARN DIFFERENTS TRAINING MODELS AND TEST THEM
    a.- The experiments can be reproduced with completeProcessCV function:
    ...
    b.- Prove different combinations for completeProcessCV. The variables and their options are detailed in the comments.
